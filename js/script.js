...
// let cloudOutSide = $(".cloud .cloud-son"); //获取外侧云层
...
mainButton.addEventListener("mousemove"， function() {
  ...
  if (isMoved) {
    ...
    // 星星向外扩散
    star[0]。style。transform = "translate(-3px,-1px)";
...
mainButton.addEventListener("mouseout"， function() {
  ...
  if (isMoved) {
    ...
    daytimeBackgrond[2]。style。transform = "translateX(50px)";
    // 星星归位
    star[0]。style。transform = "translate(0px,0px)";
    star[1]。style。transform = "translate(0px,0px)";
    star[2]。style。transform = "translate(0px,0px)";
    star[3]。style。transform = "translate(0px,0px)";
    star[4]。style。transform = "translate(0px,0px)";
    star[5]。style。transform = "translate(0px,0px)";
  } else {
    // 当白天状态时，鼠标挪出按钮
    // 按钮和背后的虚影向左平移10像素 
